...
var fr;
var star_score,empty_star,one_star,two_star;
var bk_song;
var cut_sound;
var sad_sound;
var eating_sound;
...
function setup() 
{
  ...
  button.mouseClicked(drop);
   ...
   star1 = createSprite(300,50,10,10);
   star1.addImage(starImg);
   star1.scale=0.02;

   star2 = createSprite(40,300,10,10);
   star2.addImage(starImg);
   star2.scale = 0.02;

   star_score = createSprite(50,20,20,20);
   star_score.addAnimation("empty",empty_star);
   star_score.addAnimation("one",one_star);
   star_score.addAnimation("two",two_star);
